...
See the [design log](https://github.com/tomtom87/Portage/blob/main/docs/design-log.md)
for the rationale and decision history behind this project (not part of this site — it's
excluded from the published docs, see [Contributing § docs](contributing.md)).

## Building this documentation site locally

See [Contributing § building the docs](contributing.md#building-the-docs-locally).
